...
<div class="max-w-md mx-auto mt-20 animate-fade-slide">
    <div class="glass-card">
        <h2 class="text-3xl font-bold mb-6 text-center text-[#2ECC9A]">Connexion</h2>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="flex items-center justify-between mt-6">
                <a class="text-sm text-gray-400 hover:text-[#2ECC9A] transition-colors" href="{{ route('register') }}">
